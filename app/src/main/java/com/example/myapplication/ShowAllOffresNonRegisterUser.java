...
public class ShowAllOffresNonRegisterUser extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_all_offres_non_register_user);
        // id connexion
    ...
    private void getOffresFromDatabase() {
        refOffres.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Toast.makeText(ShowAllOffresNonRegisterUser.this, "Erreur lors de l'affichage des offres.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
