...
public class offreAdapter extends RecyclerView.Adapter<offreAdapter.MyView> {

    private ArrayList<Offre> listOffres = new ArrayList<>();
    public offreAdapter(ArrayList<Offre> list) {
        this.listOffres = list;
    }
    @NonNull
    @Override
    public MyView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.offre,parent,false);
